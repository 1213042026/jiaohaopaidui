    ...
    $('#grid1').datagrid({
        ...
        columns: [
            [
                ...
                {title: '标题', width: 100, field: 'sname', sortable: true}
            ]
        ], toolbar: [
            {
                text: '新增',
...
<div id="managerDialog" class="easyui-dialog" title="医院风采管理" style="width:650px;height:350px;" toolbar="#dlg-toolbar"
    ...
    <form id="managForm" name="managForm" method="post" enctype="multipart/form-data">
        ...
        <table cellpadding="1" cellspacing="1" class="tb_custom1">
            ...
            <tr>
                <th width="30%" align="right"><label>详细信息：</label></th>
