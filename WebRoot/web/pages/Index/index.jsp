...
<head id="Head1">
    ...
    if(roletype == "1"){
    	_menus = {
   	         "menus": [
   	             /*{"menuid": "1", "icon": "icon-magic", "menuname": "业务类型管理",
   	                 "menus": [
   	                     {"menuid": "12", "menuname": "业务类型管理", "icon": "icon-database", "url": "<%= __APP__%>/Obj!keshi"}
   	               
   	                 ]},*/

   	              {"menuid": "1", "icon": "icon-magic", "menuname": "排队叫号",
	   	                 "menus": [
	   	                     {"menuid": "12", "menuname": "排队列表", "icon": "icon-database", "url": "<%= __APP__%>/Bill!bill"}
	   	                 ]},
   	          ...
   	          {"menuid": "56", "icon": "icon-role", "menuname": "业务类型管理",
   	                 "menus": [
   	                     {"menuid": "31", "menuname": "业务类型列表", "icon": "icon-users", "url": "<%= __APP__%>/User!yisheng"}
   	                 ]
