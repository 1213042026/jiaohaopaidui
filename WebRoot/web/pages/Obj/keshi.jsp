...
$(function () {
    $('#grid1').datagrid({
        ...
        striped: true,
        fit: true,
        url: "<%=__APP__%>/Obj!getList?type=1",
        idField: 'id',
        pagination: true,
        rownumbers: true,
        pageSize: 10,
...
<div id="managerDialog" class="easyui-dialog" title="业务类型简介管理" style="width:450px;height:350px;" toolbar="#dlg-toolbar"
    ...
    <form id="managForm" name="managForm" method="post" enctype="multipart/form-data">
        ...
        <input type="hidden" id="type" name="obj.type" value="1"/>
        <table cellpadding="1" cellspacing="1" class="tb_custom1">
            <tr>
                <th width="30%" align="right"><label>业务类型名称：</label></th>
            ...
            <tr>
                <th width="30%" align="right"><label>介绍：</label></th>
