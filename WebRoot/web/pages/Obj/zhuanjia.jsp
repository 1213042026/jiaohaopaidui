    ...
    $('#grid1').datagrid({
        ...
        columns: [
            [
                ...
                {title: '职位', width: 100, field: 'clert', sortable: true},
                {title: '科别', width: 100, field: 'yuanxi', sortable: true},
...
<div id="managerDialog" class="easyui-dialog" title="专家管理" style="width:450px;height:350px;" toolbar="#dlg-toolbar"
    ...
    <form id="managForm" name="managForm" method="post" enctype="multipart/form-data">
        ...
        <table cellpadding="1" cellspacing="1" class="tb_custom1">
            ...
            <tr>
                <th width="30%" align="right"><label>业务类型：</label></th>
                <td width="60%" colspan="1">
