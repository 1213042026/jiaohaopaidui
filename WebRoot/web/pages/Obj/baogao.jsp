...
$(function () {
    $('#grid1').datagrid({
        ...
        striped: true,
        fit: true,
        url: "<%=__APP__%>/Obj!getList?type=10",
        idField: 'id',
        pagination: true,
        rownumbers: true,
        pageSize: 10,
        ...
        columns: [
            [
                ...
                {title: '姓名', width: 100, field: 'title', sortable: true},
                {title: '名称', width: 100, field: 'course', sortable: true},
                {title: '结果', width: 100, field: 'note', sortable: true}
            ]
        ], toolbar: [
            {
                text: '新增',
...
<div id="managerDialog" class="easyui-dialog" title="报告管理" style="width:450px;height:350px;" toolbar="#dlg-toolbar"
    ...
    <form id="managForm" name="managForm" method="post" enctype="multipart/form-data">
        ...
        <input type="hidden" id="type" name="obj.type" value="10"/>
        <table cellpadding="1" cellspacing="1" class="tb_custom1">
            ...
            <tr>
                ...
                <td width="60%" colspan="1">
                    <input id="course" name="obj.course" class="easyui-validatebox"
                           style="width:300px;word-wrap: break-word;word-break:break-all;" type="text" required="true"
                           validType="length[0,100]"/>
                </td>
            </tr>
            ...
            <tr>
                <th width="30%" align="right"><label>结果：</label></th>
                <td width="60%" colspan="1">
                    <textarea id="note" name="obj.note" class="easyui-validatebox"
                           style="width:300px;word-wrap: break-word;word-break:break-all;" type="text" required="true"
