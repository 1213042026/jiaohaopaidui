    ...
    $('#grid1').datagrid({
        ...
        columns: [
            [
                ...
                {title: '预约叫号编号', width: 50, field: 'id', sortable: true},
                {title: '名称', width: 300, field: 'shop', sortable: true},
                //{title: '预约叫号方式', width: 100, field: 'way', sortable: true},
